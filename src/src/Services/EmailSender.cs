...
namespace src.Services
{
    ...
    public class EmailSender : IEmailSender
    {
        ...
        {
            _dotnetdesk.SendEmailLocallyAsync(true, subject, message, email, _smtpLocalOptions.fromEmail, _smtpLocalOptions.localDestination).Wait();


            //send email using sendgrid via dotnetdesk
            // uncomment to use sendgrid via dotnetdesk
